...
const TripMapInner = dynamic(
  () => import("./trip-map-inner").then((module) => module.TripMapInner),
  {
    ssr: false,
    loading: () => (
      <div className="flex h-[240px] w-full items-center justify-center doodle-box-alt border border-white/70 bg-neutral-50 text-[13px] text-neutral-400">
        Memuat peta...
      </div>
    ),
  },
...
export function TripMap({
  ...
  if (points.length === 0) {
    return (
      <div className="flex h-[180px] w-full flex-col items-center justify-center gap-2 doodle-box-alt border border-dashed border-slate-200/70 bg-neutral-50 px-4 text-center">
