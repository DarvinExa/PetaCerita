...
function SaveBudgetButton() {
  ...
  return (
    <button
      ...
      className="doodle-button inline-flex h-10 items-center justify-center doodle-box-alt border border-white/70 bg-white px-3 text-neutral-600 transition-all duration-300 ease-in-out hover:bg-neutral-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 disabled:opacity-50"
      disabled={pending}
    >
...
export function BudgetPlanner({
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-col divide-y divide-neutral-200 doodle-box-alt border border-white/70 bg-white">
