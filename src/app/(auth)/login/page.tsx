  ...
  return (
    <Card>
      <CardContent className="flex flex-col gap-5 p-6">
        ...
        {pesan === "cek-email" ? (
          <p className="rounded-md border border-teal-200 bg-teal-50 px-3 py-2.5 text-[13px] text-teal-800">
            Cek email kamu untuk konfirmasi akun, lalu masuk di sini.
          </p>
        ) : null}
        {error ? (
          <p className="rounded-md border border-danger/30 bg-danger/5 px-3 py-2.5 text-[13px] text-danger">
