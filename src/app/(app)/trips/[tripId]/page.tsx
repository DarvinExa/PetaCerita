...
export default async function TripDetailPage({
  ...
  return (
    <div className="mx-auto w-full max-w-[1200px] flex-1 px-4 py-8 sm:py-10">
      ...
      <section className="relative mb-8 overflow-hidden rounded-lg border border-teal-200 bg-white p-5 shadow-sm sm:p-7">
        <span
      ...
      <section className="flex flex-col gap-3">
        <div className="flex items-center justify-between gap-3">
          ...
          <Link
            ...
            className="inline-flex min-h-11 items-center gap-1 rounded-md text-[13px] font-semibold text-teal-700 hover:text-teal-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600"
          >
            Buka jadwal lengkap
            ...
            <Card key={day.id} className="overflow-hidden p-0">
              <div className="flex items-center justify-between gap-4 border-b border-neutral-200 bg-neutral-50 px-4 py-3">
                <div className="flex items-center gap-3">
                  <span className="flex size-8 items-center justify-center rounded-md bg-teal-800 text-[12px] font-bold text-white">
                    {index + 1}
                  </span>
                  <div>
