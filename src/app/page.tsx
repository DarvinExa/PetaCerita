...
export default function HomePage() {
  return (
    <main className="overflow-hidden bg-slate-50 text-slate-800">
      <section className="relative mx-auto grid min-h-[760px] w-full max-w-[1240px] items-center gap-14 px-5 py-20 lg:grid-cols-[1.05fr_.95fr] lg:px-8 lg:py-28">
        <div
          className="absolute -left-20 top-16 size-72 rounded-full bg-teal-100/70 blur-3xl"
          aria-hidden
        />
        <div
          className="absolute -right-24 top-28 size-80 rounded-full bg-coral-100/70 blur-3xl"
          aria-hidden
        />
        <div className="relative z-10">
          ...
          >
            Trip bareng jadi lebih ringan
          </Badge>
          <h1 className="mt-7 max-w-3xl text-[42px] font-extrabold leading-[1.08] tracking-[-0.045em] text-slate-800 sm:text-6xl lg:text-[68px]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[540px]">
          <div className="soft-surface rotate-1 rounded-[36px] p-4 shadow-[0_30px_80px_rgba(15,118,110,.16)] transition-all duration-300 ease-in-out hover:rotate-0 hover:scale-[1.02]">
            <div className="rounded-[28px] bg-white p-5 sm:p-6">
              <div className="flex items-center justify-between">
                ...
                <span className="flex size-12 items-center justify-center rounded-2xl bg-coral-100 text-coral-500">
              ...
              <div className="mt-5 rounded-3xl bg-sky-50 p-4">
                <div className="flex h-40 items-center justify-center rounded-2xl bg-[radial-gradient(circle_at_20%_30%,#99f6e4_0,transparent_24%),radial-gradient(circle_at_78%_62%,#fecaca_0,transparent_22%),#e0f2fe]">
              ...
              <div className="mt-4 space-y-3">
                {[
                  ...
                  >
                    <span className="flex size-9 items-center justify-center rounded-xl bg-teal-100 text-xs font-extrabold text-teal-800">
      ...
      <section className="mx-auto w-full max-w-[1240px] px-5 py-20 lg:px-8">
        ...
        <div className="mt-12 grid gap-5 md:grid-cols-3">
          {highlights.map(({ icon: Icon, tone, title, body }) => (
            <Card key={title} className="soft-lift border-transparent p-2">
              <CardHeader>
                <span
      ...
      <section className="mx-auto w-full max-w-[1240px] px-5 py-20 lg:px-8">
        <div className="rounded-[40px] bg-teal-900 px-6 py-12 text-white shadow-[0_28px_80px_rgba(15,118,110,.22)] sm:px-10 lg:px-14">
          <div className="grid gap-10 lg:grid-cols-[.8fr_1.2fr]">
            <div>
              ...
              <p className="mt-4 font-medium leading-relaxed text-teal-100">
      ...
      <section className="mx-auto w-full max-w-[980px] px-5 py-24 text-center">
        <span className="mx-auto flex size-16 items-center justify-center rounded-3xl bg-coral-100 text-coral-500 shadow-[0_12px_34px_rgba(169,79,64,.13)]">
